...
public class RelatorioDeFuncionariosTest {
    ...
    public void casoDeTeste01() {
        ...
        // Configuro o mock da interface ReceitaFederal para retornar o valor
        // falso quando qualquer invocação do método isCPFBloqueado.
        Mockito.when(receitaFederal.isCPFBloqueado(Mockito.anyString())).thenReturn(false);
        // Configuro o mock da interface ReceitaFederal para retornar o valor
        ...
        // Assert
        // Defino a quantidade de funcionários com CPF não bloqueados eu espero
